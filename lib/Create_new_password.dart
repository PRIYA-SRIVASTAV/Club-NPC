...
class Create_new_password extends StatefulWidget {
  var emailID;
  Create_new_password({required this.emailID,super.key});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              textFieldContainer(
                  newPassword, context, "Enter New Password", Icons.remove_red_eye),
              SizedBox(
                height: 3.h,
              ),
              Text(
              ...
              textFieldContainer(
                  newConfirmPassword, context, "Enter Confirm Password", Icons.remove_red_eye),
              SizedBox(
                height: 3.h,
              ),
              SizedBox(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    change_Password_Controller().change_password_Method(newPassword.text, newConfirmPassword.text, widget.emailID, context);
                  },
